...
import com.he.common.domain.impl.Practice;
...
public class DomainAppAppManifest implements AppManifest {
    ...
    private static final Logger log = Logger.getLogger(DomainAppAppManifest.class);
    ...
    public DomainAppAppManifest() 
    {
    	...
    	log.debug("[The Classpath in DomainApp  :" + System.getProperty("java.class.path"));
